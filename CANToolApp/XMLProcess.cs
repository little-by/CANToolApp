    ...
    public class XMLProcess
    {
        ...
        public static void Insert(string path, string node, string element, string attribute, string value)
        {
            try
            {
                ...
                if (xn == null)
                {
                    ...
                    xn = doc.CreateNode(XmlNodeType.Element, node, null);
                ...
                //Console.WriteLine("-------AppDomain.CurrentDomain.BaseDirectory.ToString() + pathing" + AppDomain.CurrentDomain.BaseDirectory.ToString() + path);
            }
            catch (Exception e)
            {
        ...
        public static void Insert(string path, string node, string element, string[][] strList)
        {
            try
            {
                ...
                xn.AppendChild(xe);
                Console.WriteLine("-------------------------------------------------"+ AppDomain.CurrentDomain.BaseDirectory.ToString() + path);
                doc.Save(AppDomain.CurrentDomain.BaseDirectory.ToString() + path);
            }
            catch { }
        }
